...
%\begin{solution}
 % We consider the DTMC characterized by $P$ obtained by uniformization of $Q$.
 % \[
 %   P=\frac{Q}{\lambda}+I \text{ with } \lambda = \max_{i\in S}-q_{i,i}
 % \]
 % It's clear that $\lambda = 3$. We see
 % \begin{align*}
 %   p_{(i,j),(i+1,j-1)} &= \frac{2}{3}\\
 %   p_{(i,j),(i-1,j+1)} &= \frac{1}{3}
 % \end{align*}
 %for $j > 0$ and $i > 0$.
%\end{solution}
