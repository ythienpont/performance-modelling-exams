...
\begin{solution}
	For PASTA to apply, the system should be memoryless, i.e. the system has no information on the arrival times of future arrivals. Since the independence property is violated, we can \textbf{not} apply the PASTA property.
\end{solution}
